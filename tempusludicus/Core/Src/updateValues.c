...
The characters '0' to '9' are represented consecutively, so subtracting the ASCII value of '0' from the ASCII value of
nextChar results in the integer value of the digit.
